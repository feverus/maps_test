...
function getRange(y: number, yMin = 30, yMax = 50, xStart = 25 ) {
...
const names = ['Работа в заповеднике', 'Приют для бездомных животных', 'Помощь бездомным животным', 'Зоопарк принимает добровольцев', 'Волонтёры в питомник', 'Сбор средств на благотоворительность', 'Помощь пожилым фермерам', 'Благотворительный забег', 'Просветительская деятельность']
...
for (let index = 0; index < countMockData; index++) {
    ...
    objects.push({id:index.toString(), 
                    ...
                    img: `media/objects-preview/${randomInt(1, 20)}.jpg`,
